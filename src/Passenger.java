...
public class Passenger extends Person {
  ...
  public void callARide() throws ParseException, InterruptedException {
    ...
    while (!(validTrip)) {
      ...
      System.out.println("Enter your starting point number:\n 1. Eden Avenue\n 2. Bhatta Chowk\n 3. DHA Phase 1\n 4. Model Town\n");
      num = input.nextInt();
      if (num==1) startingPoint = "Eden Avenue";
      else if (num == 2) startingPoint = "Bhatta Chowk";
      else if (num == 3) startingPoint = "DHA Phase 1";
      else startingPoint = "Model Town";
      System.out.println("Enter your destination number:\n 1. Eden Avenue\n 2. Bhatta Chowk\n 3. DHA Phase 1\n 4. Model Town\n");
      num = input.nextInt();
      if (num==1) destination = "Eden Avenue";
      else if (num == 2) destination = "Bhatta Chowk";
      else if (num == 3) destination = "DHA Phase 1";
      else destination = "Model Town";
  ...
  public void callARideSimulator() throws ParseException, InterruptedException {
    ...
    while (!(validTrip)) {
      ...
      if (rand==1) startingPoint = "Eden Avenue";
      else if (rand == 2) startingPoint = "Bhatta Chowk";
      else if (rand == 3) startingPoint = "DHA Phase 1";
      else startingPoint = "Model Town";
      ...
      if (rand==1) destination = "Eden Avenue";
      else if (rand == 2) destination = "Bhatta Chowk";
      else if (rand == 3) destination = "DHA Phase 1";
      else destination = "Model Town";
